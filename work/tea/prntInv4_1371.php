	...
	<div id="print_tbl">
	    ...
	    */
			...
			echo '<tr ' . $lineBold . '>
				<td>' . $lin_No . ' </td>
                <td>' . $itm['ItemNo'] . '</td>
                <td colspan="2" >  ' . substr($itmDescription, 0, 50) . '</td>
                <td align="right">' . $qty . '</td>
                <td align="right">' . $itm['Unit'] . '</td>
                <td align="right">' . numFormt2($fixedPrice) . '</td>
				<td align="right">' . numFormt2($disPer) . '</td>
				<td align="right">' . numFormt2($finTot) . '</td>
             </tr>';
