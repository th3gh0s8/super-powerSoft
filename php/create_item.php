                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-sm-2 col-md-2 col-xs-12">
                                                                <label style="margin-top:-4px;"> <input type="checkbox" name="at_id" id="at_id" class="at_id" value="at_id">
                                                                    ...
                                                                    Item No </label>
                                                                <input id="itm_no2" type="text" fixedCode="<?php echo $fixCode; ?>" list="itmList" name="itm_no2" class="chaBlock form-control txt-auto stock TxtID charKey fixCodes" placeholder="" style="font-size:14px;" autofocus required onkeyup="syncBarcode();" > <span class="charCount " style="background-color:#9c9fe5; padding:2px; color:white; border-radius:50%; width:23px; hposition: absolute; top: 73%; right: 5px; transform: translateY(-50%);">0</span>
                                                            </div>
