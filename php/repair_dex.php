...
$(document).ready(function() {
    ...
    // Handle save button in customer creation modal
    $(document).on('click', '.Cus_saveData', function(e) {
        e.preventDefault();
        
        // Get values from modal form
        var cusName = $('.customerName').val();
        var moblNo = $('input[name="moblNo"]').val();
        ...
        $('#Cusname').val(cusName);
        $('#mobileNo').val(moblNo || telphone); // Use mobile no or telephone
        $('#address').val(address);
        ...
        alert('Customer created successfully! Data has been populated in the form.');
    });
});
</script>
